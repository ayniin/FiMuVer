...
//   - Hat mehrere Actors (N:M über MovieActor)
...
type Movie struct {
	...
	MovieActors     []MovieActor     `gorm:"foreignKey:MovieID" json:"actors,omitempty"`
	MovieGenres     []MovieGenre     `gorm:"foreignKey:MovieID" json:"genres,omitempty"`
	CollectionItems []CollectionItem `gorm:"foreignKey:MovieID" json:"collection_items,omitempty"`
}
